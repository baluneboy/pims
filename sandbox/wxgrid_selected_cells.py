...
class MyPanel(wx.Panel):
    ...
    def printSelectedCells(self, top_left, bottom_right):
        """
        Based on code from <a href="http://ginstrom.com/scribbles/2008/09/07/getting-the-selected-cells-from-a-wxpython-grid/">http://ginstrom.com/scribbles/2008/09/07/getting-the-selected-cells-from-a-wxpython-grid/</a>
        """
        cells = []
