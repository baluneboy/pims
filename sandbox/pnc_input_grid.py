...
class SpecialEnterHandlingGrid(SimpleGrid):

    def __init__(self, parent, log):
        super(SpecialEnterHandlingGrid, self).__init__(parent, log)
        self.SetCellValue(0, 0, "Enter moves to the right")
        self.SetCellValue(0, 4, "Enter wraps to next row")
...
class TestFrame(wx.Frame):
    def __init__(self, parent, log):
        wx.Frame.__init__(self, parent, -1, "Special Enter Handling Grid Demo", size=(640,480))
        self.grid = SpecialEnterHandlingGrid(self, log)
