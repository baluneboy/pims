...
from obspy.core.ascii import readSLIST, readTSPAIR, isSLIST, isTSPAIR, writeTSPAIR, writeSLIST
...
def demo(filename='/home/pims/dev/programs/python/pims/sandbox/data/slist3traces.ascii'):
    """Demo StringIO handling."""
    from obspy.core import read
    from cStringIO import StringIO
    
    s = StringIO(filename)
    st = read(s.getvalue(), format="SLIST")
    s.close()
    print st
