...
init(autoreset=True)
print(Fore.BLACK + Back.MAGENTA + Style.BRIGHT + 'Line 1: colored, with autoreset=True')
print('Line 2: When auto reset is True, the color settings need to be set with every print.')

init(autoreset=False)
print(Fore.BLACK + Back.YELLOW + Style.BRIGHT + 'Line 3: colored, with autoreset=False')
