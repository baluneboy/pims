...
def demo_chirp(fs=44100):
    ...
    print '\ndemo with artificial chirp signal (not representative of accel data)'
    ...
    print 'note: these demo_chirp files are not representative of microgravity acceleration data'
